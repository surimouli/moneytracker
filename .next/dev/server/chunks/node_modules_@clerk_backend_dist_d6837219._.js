...
;
;
var errorThrower = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$error$2d$inWE1T1f$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildErrorThrower"])({
...
"[project]/node_modules/@clerk/backend/dist/chunk-AIEGYSDW.mjs [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
function parseErrors(data) {
    if (!!data && typeof data === "object" && "errors" in data) {
        ...
        return errors.length > 0 ? errors.map(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$error$2d$inWE1T1f$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseError"]) : [];
    }
    return [];
}
function withLegacyRequestReturn(cb) {
    return async (...args)=>{
        ...
        if (errors) {
            const error = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$error$2d$inWE1T1f$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ClerkAPIResponseError"](statusText || "", {
                data: [],
                status,
                clerkTraceId,
                retryAfter
...
function handleClerkAPIError(tokenType, err, notFoundMessage) {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$error$2d$inWE1T1f$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isClerkAPIResponseError"])(err)) {
        let code;
        let message;
        switch(err.status){
            case 401:
...
//# sourceMappingURL=node_modules_%40clerk_backend_dist_d6837219._.js.map